(function () {
  ...
  function toggleTheme() {
    ...
    if (html.getAttribute("data-theme-mode") === "dark") {
      ...
      localStorage.removeItem("Nixlotdarktheme");
      localStorage.removeItem("NixlotMenu");
      localStorage.removeItem("NixlotHeader");
      ...
      document.querySelector("#switcher-background1").checked = false;
      document.querySelector("#switcher-background").checked = false;
      localStorage.setItem("Nixlotdarktheme", "true");
      localStorage.setItem("NixlotMenu", "dark");
      localStorage.setItem("NixlotHeader", "dark");
      localStorage.removeItem("bodylightRGB");
      localStorage.removeItem("bodyBgRGB");
    }
  }
